    ...
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 fade-up fade-up-1">
        <div className="glass rounded-xl p-5">
          ...
          <p className={`text-3xl font-bold tabular-nums stat-value ${activeCount > 0 ? "text-red-400" : "text-[var(--text-primary)]"}`}>
            {activeCount}
          </p>
        </div>
        <div className="glass rounded-xl p-5">
        ...
        {allAnomalies.length === 0 ? (
          <div className="glass rounded-xl p-16 text-center">
            <div className="inline-flex items-center justify-center w-12 h-12 rounded-xl bg-[var(--bg-surface)] mb-4">
              <Shield className="h-6 w-6 text-[var(--text-faint)]" />
            </div>
            ...
            {allAnomalies.map((anomaly) => {
              ...
              return (
                <Link
                  ...
                  className="group glass rounded-xl p-5 flex items-start gap-4 transition-all duration-200 hover:border-[var(--border-strong)] block"
                >
                  {/* Timeline dot */}
                  <div className="flex flex-col items-center shrink-0 pt-1">
                    ...
                    />
                    <div className="w-[1px] h-8 bg-[var(--bg-surface-hover)] mt-1" />
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    {diagnosis.recommendation && (
                      <p className="text-[12px] text-[var(--text-muted)] mt-1 line-clamp-1">
